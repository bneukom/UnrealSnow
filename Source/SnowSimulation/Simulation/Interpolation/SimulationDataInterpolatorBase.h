...
public:
	...
	*/
	virtual FTemperature InterpolateTemperatureByAltitude(FTemperature& BaseTemperatur, const FVector& Position) PURE_VIRTUAL(USimulationDataInterpolatorBase::InterpolateTemperatureByAltitude, return FTemperature(););
