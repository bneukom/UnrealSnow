...
void UDegreeDayGPUSimulation::Initialize(ASnowSimulationActor* SimulationActor, UWorld* World)
{
	...
	SimulationComputeShader->Initialize(Cells, *ClimateData, k_e, k_m, TMeltA, TMeltB, TSnowA, TSnowB, TotalHours, CellsDimensionX, CellsDimensionY, SimulationActor->ClimateDataComponent->GetResolution(), SimulationActor->ClimateDataComponent->GetMeasurementAltitude(), MaxSnow);
